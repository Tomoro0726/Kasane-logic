...
mod tests {
    ...
    fn test_dimension_range_display() {
        assert_eq!(
            Single(5u32).to_string(),
            "5"
        );
        assert_eq!(
            LimitRange(10u32, 20u32).to_string(),
            "10:20"
        );
        assert_eq!(
            BeforeUnLimitRange(15u32).to_string(),
            "-:15"
        );
        assert_eq!(
            AfterUnLimitRange(25u32).to_string(),
            "25:-"
        );
        assert_eq!(
            Any::<u32>.to_string(),
    ...
    fn test_dimension_range_display_negative() {
        assert_eq!(
            Single(-5i32).to_string(),
            "-5"
        );
        assert_eq!(
            LimitRange(-10i32, -5i32).to_string(),
            "-10:-5"
        );
        assert_eq!(
            BeforeUnLimitRange(-1i32).to_string(),
            "-:-1"
        );
        assert_eq!(
            AfterUnLimitRange(-5i32).to_string(),
            "-5:-"
        );
    }
